...
module.exports = {
  ...
  collect: (goodsId,token)=>{
    return request('/shop/goods/fav/add', true, 'post', { goodsId,token})
  },
  checkCollect: (goodsId, token) => {
    return request('/shop/goods/fav/check', true, 'post', { goodsId, token })
  },
  deleteCollect: (goodsId, token) => {
    return request('/shop/goods/fav/delete', true, 'post', { goodsId, token })
  },
  collectList:(token) => {
    return request('/shop/goods/fav/list', true, 'post', { token })
  }
}